...
export async function initializeDatabase() {
  try {
    ...
    await query(`CREATE INDEX IF NOT EXISTS idx_badminton_config_match_id ON badminton_match_config(match_id)`)
    ...
    await query(`CREATE INDEX IF NOT EXISTS idx_table_tennis_config_match_id ON table_tennis_match_config(match_id)`)
